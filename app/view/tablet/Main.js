        ...
        items: [
            {
                ...
                xtype : 'titlebar',
                docked: 'top',
                title : 'Career Development of My Reports',
            },
            {
                id: 'launchscreen',
                cls : 'panel',
                html: '<center><canvas id="mycanvas" width="980" height="680" style="border:1px dashed gray">no canvas support</canvas></center>',
                scrollable: true,
                centered : true,
                width:1000,
                height:700,
